...
function MobileOtpForm(props) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        ...
        dispatch(action_1.resendOtpSmsLoading({
          email: props.email,
          password: base_64_1.encode(props.password) //TODO
  ...
  return React.createElement("div", null, isMobileView_1["default"] && React.createElement("div", {
    ...
    onClick: resendOtp
  }, timerCompleted ? React.createElement("span", {
    className: 'text-center'
  }, "Retry ") : React.createElement("div", {
    className: 'flex justify-center'
  }, React.createElement("span", {
    className: 'text-center'
  }, "Retry ( "), React.createElement(react_countdown_1["default"], {
    date: timer,
    className: 'ml-2',
    onComplete: function onComplete() {
      return setTimerCompleted(true);
    },
    renderer: function renderer(counterProps) {
      return React.createElement("div", null, " ", counterProps.seconds, " : ", counterProps.minutes, " ");
    }
