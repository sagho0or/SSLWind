...
function PasswordRegisterForm(props) {
    ...
    var _c = react_1.useState('password'), passwordType = _c[0], setPasswordType = _c[1];
    var _d = react_1.useState('password'), confirmPasswordType = _d[0], setConfirmPasswordType = _d[1];
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        isMobileView_1["default"] &&
            react_1["default"].createElement("div", { className: 'absolute top-10 cursor-pointer', onClick: props.backFunc },
                react_1["default"].createElement(Icons_1["default"], { name: 'left-arrow-key' })),
        react_1["default"].createElement("div", { className: "relative " + (isMobileView_1["default"] ? 'h-screen-190' : '') },
            react_1["default"].createElement(RegisterStepProgress_1["default"], { step: 3 }),
            react_1["default"].createElement("div", { className: 'my-10 relative' },
                react_1["default"].createElement(Input_1["default"], { inputId: 'password', label: "password", type: passwordType, value: password, onChange: passwordChange, style: 'secondaryOutline' }),
                react_1["default"].createElement("div", { className: 'absolute top-11 left-2 cursor-pointer', onClick: function () { return setPasswordType(passwordType == 'password' ? 'text' : 'password'); } },
                    react_1["default"].createElement(Icons_1["default"], { name: 'password' }))),
            react_1["default"].createElement("div", { className: 'my-10 relative' },
                react_1["default"].createElement(Input_1["default"], { inputId: 'confirmPassword', label: "Repeat Password", type: confirmPasswordType, value: confirmPassword, onChange: function (e) {
                        return setConfirmPassword(e.target.value);
                    }, style: 'secondaryOutline' }),
                react_1["default"].createElement("div", { className: 'absolute top-11 left-2 cursor-pointer', onClick: function () { return setConfirmPasswordType(confirmPasswordType == 'password' ? 'text' : 'password'); } },
                    react_1["default"].createElement(Icons_1["default"], { name: 'password' }))),
