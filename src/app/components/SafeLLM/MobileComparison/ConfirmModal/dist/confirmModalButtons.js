...
function ConfirmModalButtons(props) {
    ...
    return (React.createElement("div", { className: 'flex' },
        ...
        isLogin && props.side === 'BID' && !timerCompleted &&
            React.createElement(Button_1["default"], { style: 'successSimple', 
                //  onClick={}
                disabled: false, customStyle: 'font-semibold flex-auto' },
        ...
        isLogin && !(props.side === 'BID') && !timerCompleted &&
            React.createElement(Button_1["default"], { style: 'errorSimple', 
                //  onClick={}
                disabled: false, customStyle: 'font-semibold flex-auto' },
                React.createElement("span", null,
                    "Confirm ( ",
